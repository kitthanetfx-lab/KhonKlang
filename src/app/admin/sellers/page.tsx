      ...
      <div className="w-full max-w-lg bg-white dark:bg-gray-900 shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <Section label="เอกสารแนบ">
            ...
            {app.companyCertFileName && <FileRow label="หนังสือรับรองบริษัท" name={app.companyCertFileName} />}
            {app.bookbankFileName    && <FileRow label="สมุดบัญชี"            name={app.bookbankFileName} />}
          </Section>
