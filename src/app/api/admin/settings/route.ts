...
const COLUMN_OF: Record<string, string> = {
  ...
  simpleFeeMinUnder1000: 'simple_fee_min_under_1000',
  simpleMiddlemanSharePercent: 'simple_middleman_share_percent',
  simpleShareTier1Multiplier: 'simple_share_tier1_multiplier',
  simpleShareTier1Percent: 'simple_share_tier1_percent',
  simpleShareTier2Multiplier: 'simple_share_tier2_multiplier',
  simpleShareTier2Percent: 'simple_share_tier2_percent',
  simpleShareTier3Multiplier: 'simple_share_tier3_multiplier',
  simpleShareTier3Percent: 'simple_share_tier3_percent',
