...
const MODES = [
  ...
  { icon: '🔍', bg: '#fff3e0', title: 'นัดออนไซต์ (ตรวจถึงที่)', href: '/service/onsite',
    desc: 'ช่างผู้เชี่ยวชาญออกไปตรวจสินค้า ณ ที่ตั้งผู้ขาย ก่อนคุณตัดสินใจซื้อ',
    feats: ['✅ ผู้เชี่ยวชาญตรวจถึงที่', '✅ รู้ผลก่อนโอนเงิน', '✅ เหมาะกับรถ-เครื่องจักร-บ้าน', '✅ มีรายงานการตรวจ'] },
];
const STEPS = [
