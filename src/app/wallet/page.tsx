    ...
    <div className="dash-root">
      ...
      <main className="dash-body wal-page">
        ...
        <p className="wal-hint">
          ยอดนี้ใช้เป็นสิทธิประมูล — ผู้ขายตั้งมัดจำคงที่ ระบบล็อกครั้งเดียวตอน Bid แรก แล้วจำยอดนั้นไว้ ถ้าชนะแล้วไม่รับของ จะหักเป็นค่าเสียเวลาให้ผู้ขาย เติมเงินแล้วระบบตรวจสลิปอัตโนมัติ ผ่านแล้วเข้ากระเป๋าทันที
        </p>
